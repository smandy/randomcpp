...
// Pointing a vector at an arbitrary arrry.
...
int main()
{
    ...
    std::cout << std::hex << &tests[0] << ": " << std::dec << tests[1] << " "
              << tests[3] << " " << tests[5] << std::endl;

    std::cout << std::hex << &targetVector[0] << ": " << std::dec
              << targetVector[1] << " " << targetVector[3] << " "
              << targetVector[5] << std::endl;
