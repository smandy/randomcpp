...
// Stolen from Stephan T Lavavej from this tutorial
// https://channel9.msdn.com/Series/C9-Lectures-Stephan-T-Lavavej-Advanced-STL/C9-Lectures-Stephan-T-Lavavej-Advanced-STL-6-of-n
...
struct default_formatter {
  template <typename T> void prefix(std::ostream &os, const T &) const {
    os << "[";
  }
  template <typename T> void separator(std::ostream &os, const T &) const {
    os << ", ";
  }
  template <typename T> void suffix(std::ostream &os, const T &) const {
    os << "]";
  }
